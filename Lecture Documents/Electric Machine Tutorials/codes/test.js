...
var org_html_manager = {
  ...
  build: function ()
  {
    ...
    {
      this.SECS[i].IDX = i;
      var html = '<table class="org-info-js_info-navigation" width="100%" border="0" style="border-bottom:0px solid black;">'
	...
	html += '</td><td style="text-align:center;vertical-align:bottom;border-style:none;width:56%;padding-bottom:10px;">';
      ...
      if(i>0 && this.SECS[i].PARENT.PARENT) // != this.ROOT)
        ...
        html += '<span style="font-style:bold;">'+this.SECS[i].HEADING.innerHTML+'</span>';

      // Right:
	html += '</td><td style="text-align:right;vertical-align:bottom;border-style:none;width:22%;padding-bottom:10px;padding-right:10px;">';
      html += (i + 1) +'</td></tr></table>';

      // buttons:
      this.SECS[i].BUTTONS = document.createElement("div");
      this.SECS[i].BUTTONS.innerHTML = '<div class="org-info-js_header-navigation" style="display:inline;float:right;text-align:right;font-size:70%;font-weight:bold;padding-top:10px;">'
        + this.LINKS
